...
public class HibernateCommonUtil {
	private static final SessionFactory sessionFactory;
	private Constants constants = new Constants();

	static {
		try {
			sessionFactory = new Configuration().configure("hibernate.cfg.common.xml").buildSessionFactory();
	...
	public static List getSQL2MapList(String sql, HashMap where) {
		...
		List list = null;
		try {
			session = HibernateCommonUtil.getSession();
