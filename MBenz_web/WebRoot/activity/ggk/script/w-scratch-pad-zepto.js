...
从jQuery依赖-->Zepto依赖
之前刮刮卡会出现刮完之后 reset 有黑线，坐下修改  up 鼠标移动上去时 this.down_move = false; 默认为false  当 down 为true  move的时候判断   reset 设置 false 所以reset之后就没有黑线了
有些机器不能刮的涂层不显示，需要在奖品层在添加一层背景，透明的层，这样就可以刮了。其他的也支持，越来越完美了 刮奖的时候请求次数，控制次数
xjw 修改于2015-01-14
*/
...
;(function ($) {
  ...
  ScratchPad.prototype = {
    ...
    reset: function () {
      ...
      this.canvas.style.backgroundImage='url('+this.options.fgblank+')';
